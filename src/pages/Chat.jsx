...
const Chat = () => {
    ...
    console.log(selecteduser_globe)
    ...
    useEffect(() => {
        ...
        }, 400); // delay of 500ms (adjust this as you want)
    ...
    useEffect(() => {
        ...
        socket.on("typingResponse", (data) => {
            console.log("typingResponse received", data);
        ...
        socket.on("stopTypingResponse", (data) => {
            console.log("stopTypingResponse received", data);
            if (data.username === chatIdRef.current) {
                setIsTyping(false)
            }
    ...
    return (
        ...
        <div className="mainchat md:flex-row gap-0 flex-col flex md:gap-2">
                ...
                <div className='flex md:flex-col justify-center items-center'>
                    ...
                    <button onClick={handleprofile} className="m-5  ">
                        {mainid.profilePic != "default" ? (
                            <div style={{ backgroundImage: `url(${mainid.profilePic})` }} className={`bg-cover bg-center w-[40px] h-[40px] rounded-full `}> </div>
                        ) : (
                            <Profile size={40} />)}
                    </button>
                </div>
            ...
            {chatselected ? (!msgloading ? (<div className={` bg-[#0B0B0F] chatarea ${chatbox}  md:flex md:w-[calc(100vw-40%)] w-[100%] fixed md:top-0 md:static flex-col`} >
                ...
                <div style={{ backgroundImage: `url("/doodle.svg")`, backgroundSize: "20px" }} className='bg-repeat bg-center ' >
                ...
                <div className={` bg-[#0B0B0F] ${chatbox} gap-4 flex-col  md:flex md:w-[calc(100vw-40%)] w-[100%] justify-center items-center `} >
                    <Lightlogo size="80" />
                    <div className='text-[#1f1f2b] text-4xl font-bold uppercase text-center ' ref={msgContainerRef} >
            ...
            <div className={`w-full h-[100svh] bg-[#0B0B0F] fixed top-0 ${mainloading} justify-center items-center`}>
                <Logo size="60" />
            </div>
            <div
                ...
                className={`w-full  h-[100svh] bg-[#0B0B0F] ${profilewindow} fixed top-0 flex justify-center items-center`}>
                <button onClick={() => {
                            ...
                            />
                            {
                                dragging
                                    ...
                                    : mainid.profilePic === "default"
                                        ? <Profile size={80} />
                                        : (
                                            <div style={{ backgroundImage: `url(${mainid.profilePic})` }} className='w-[80px] h-[80px] rounded-full flex justify-center items-center bg-cover bg-center ' >
